...
export const metadata: Metadata = {
  ...
  description: "Beam & Beat - ритм-игра где вы поражаете цели в такт музыки. Создавайте битмапы из WAV-файлов в нашем редакторе. Скачайте альфа-версию бесплатно.",
  keywords: "\
...
игра, ритм, аудио, редактор, editor, beam, beat, битмап, beatmap\
  ".trim(),
  openGraph: {
    title: "Beam & Beat - Ритм-игра с битмап редактором",
    description: "Поражайте цели в такт музыки. Создавайте битмапы из любых WAV-файлов. Скачайте альфа-версию.",
    type: 'website',
    locale: 'ru_RU',
    siteName: 'Beam & Beat',
  }
