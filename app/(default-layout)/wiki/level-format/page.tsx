        ...
        <>
            ...
            <ul className="list-disc pl-6 space-y-2">
                <li>
                    <code>info.json</code>
                    { " " }
                    — Паспорт уровня (метаданные).
                </li>

                <li>
                    <code>beatmap.json</code>
                    { " " }
                    — Сценарий геймплея (ноты и тайминги).
                </li>

                <li>
                    <code>audio.wav</code>
                    { " " }
                    — Аудиофайл (название указывается в info.json).
                </li>
            </ul>
  ...
  "levelInfo": {
    ...
    "beatmapFileName": "beatmap.json"   // Ссылка на файл карты
            ...
            <blockquote>
                ...
                <code>id</code>
                { " " }
                используется для корректного запуска уровня в игре и создания файла сохранения (
                { }
                <code>.sav</code>
                { }
                ). Крайне не рекомендуется редактировать это поле. Оно должно совпадать с названием папки уровня.
            </blockquote>
     ...
     "power": 1500   // Базовая скорость полета целей
            ...
            <ul className="list-disc pl-6 space-y-2">
                <li>
                    <strong>beat</strong>
                    { " " }
                    (float): Временная метка в битах. Например,
                    { " " }
                    <code>4.0</code>
                    { " " }
                    — начало 4-го удара,
                ...
                <li>
                    <strong>id</strong>
                    { " " }
                    (int): Координата на сетке 7x7. Значения от
                    { " " }
                    <code>0</code>
                    { " " }
                    (левый нижний угол) до
                    { " " }
                    <code>48</code>
                    { " " }
                    (правый верхний).
                ...
                <li>
                    ...
                    { " " }
                    (object, optional): Переопределение глобальных настроек для конкретной ноты (например, изменение скорости).
                </li>
            </ul>
