...
export default function WikiHomePage() {
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 not-prose mt-6">
                <div>
                    ...
                    <ul className="space-y-3">
                        <li>
                            <Link className="block group" href={ paths.wiki.installation }>
                        ...
                        <li>
                            <Link className="block group" href={ paths.wiki.requirements }>
                        ...
                        <li>
                            <Link className="block group" href={ paths.wiki.customLevels }>
                        ...
                        <li>
                            <Link className="block group" href={ paths.wiki.gameplay }>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li>
                            <Link className="block group" href={ paths.wiki.editorGuide }>
                        ...
                        <li>
                            <Link className="block group" href={ paths.wiki.levelFormat }>
                        ...
                        <li>
                            <Link className="block group" href={ paths.wiki.faq }>
            ...
            <p>
                Вики поддерживается сообществом. Если вы нашли ошибку или хотите дополнить статью, обязательно напишите нам в
                { " " }
                <Link isExternal href={ siteConfig.links.telegram } underline="hover">Telegram</Link>
                .
            </p>
        </>
    );
