...
export default function InstallationPage() {
    return (
        <>
            ...
            <ol>
                <li>Перейдите на страницу <Link href={paths.download} underline="hover">Скачать</Link>.</li>
                <li>Нажмите кнопку загрузки последней версии.</li>
                <li>Дождитесь окончания загрузки файла (это будет <code>.zip</code> архив).</li>
            </ol>

            <h3>2. Распаковка</h3>
            <ul>
                <li>Нажмите правой кнопкой мыши на скачанный архив.</li>
                <li>Выберите <strong>"Извлечь всё..."</strong> (или воспользуйтесь WinRAR/7-Zip).</li>
                <li>Выберите удобную папку (например, <code>C:\Games\BeamNBeat</code>).</li>
            </ul>
            ...
            <ul>
                <li>Найдите файл <strong>BeamNBeat.exe</strong> (у него иконка игры).</li>
            ...
            <p>
                ...
                <br/>
                Нажмите <u>"Подробнее"</u> {"->"} <u>"Выполнить в любом случае"</u>.
            </p>

            <h3>Ошибки отсутствующих DLL</h3>
            <p>
                Если при запуске вы видите ошибку об отсутствии файлов (например, <code>VCRUNTIME140.dll</code>, <code>MSVCP140.dll</code>), вам необходимо установить системные библиотеки Microsoft:
            </p>
            <ul>
                <li><Link isExternal href="https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist" underline="hover">Visual C++ Redistributable (x64)</Link></li>
                <li><Link isExternal href="https://www.microsoft.com/en-us/download/details.aspx?id=35" underline="hover">DirectX End-User Runtime</Link></li>
            </ul>
        </>
    )
}