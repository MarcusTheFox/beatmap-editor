                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-content2 p-6 rounded-xl flex flex-col items-center text-center gap-4">
                                <div className="bg-primary/10 text-primary p-3 rounded-lg">
                                    <Icon24MusicOutline height={ 32 } width={ 32 } />
                                </div>
                            ...
                            <div className="bg-content2 p-6 rounded-xl flex flex-col items-center text-center gap-4">
                                <div className="bg-warning/10 text-warning p-3 rounded-lg">
                                    <Icon20ZipOutline height={ 32 } width={ 32 } />
                                </div>
                ...
                <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div className="flex flex-col gap-6">
                            <Step description="Выберите трек с четким ритмом в формате .wav." num="1" title="Подготовьте музыку" />
                            <Step description="Загрузите файл, расставьте цели на игровом поле и настройте их." num="2" title="Создайте карту" />
                            <Step description="Сохраните уровень в .zip и протестируйте его в игре." num="3" title="Экспортируйте и играйте" />
                        </div>
                    </div>
                    ...
                    <div className="bg-night-500 w-full min-h-[350px] rounded-2xl flex items-center justify-center border border-night-600 overflow-clip">
                        <Image unoptimized alt="Гиф как начать работу с редактором" src={ editorUsingGif }/>
                    </div>
                </div>
            </section>
        </LayoutWithLights>
