...
export const VersionLog: VersionLogType = {
    ...
    body: (
        <>
            ...
            <Alert variant="faded" color="warning" title={<b>Внимание</b>} className="text-sm">
            ...
            <ul>
                <li>
                    Файл <code>info.json</code> полностью переработан.
                </li>
                <li>
                    В <code>beatmap.json</code> свойства нот (например, <code>power</code>) теперь находятся внутри объекта <code>properties</code>.
                </li>
            </ul>
            <Alert variant="faded" color="danger" title={<b>Внимание</b>} className="text-sm">
                <span>Карты, созданные для версии <code className="text-danger-700">0.1.0-alpha</code>, <strong className="text-danger-700">несовместимы</strong> с новой версией. Пожалуйста, пересоздайте ваши уровни в обновленном редакторе.</span>
            </Alert>
